...
**Download:** [Waggle-1.4.2.apk](https://shakhtar-sankur.github.io/gigzen/Waggle-1.4.2.apk)
(8.2 MB, Android 7.0+) &nbsp;·&nbsp;
...
- **Version 1.4.2 (build 14)**, signed release, in closed testing. Not yet on Google Play, so the
